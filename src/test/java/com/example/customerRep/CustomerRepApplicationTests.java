...
class CustomerRepApplicationTests {
	...
	@Test
	void saveMergeTest(){
		List<CustomerDto> customerDtos = List.of(new CustomerDto(10026L,"3333",0,"sasha","masha"),
											new CustomerDto(10027L,"1111",0,"uuuuuuu","masha"),
											new CustomerDto(10028L,"2222",0,"sashadd","mashafef"));
