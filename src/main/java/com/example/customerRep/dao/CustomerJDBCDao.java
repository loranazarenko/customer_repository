...
/*        jdbcTemplate.execute("drop table IF EXISTS Customer_tmp;" +
        ...
        final SimpleJdbcInsert statement = new SimpleJdbcInsert(jdbcTemplate.getDataSource())
                ...
                .usingColumns("id", "code", "isDeleted", "firstName", "lastName");
        ...
        String sql =
                "MERGE Customer AS TARGET\n" +
                        ...
                        "WHEN MATCHED AND TARGET.firstname <> SOURCE.firstName OR TARGET.lastName <> SOURCE.lastName \n" +
                        "THEN UPDATE SET TARGET.firstname = SOURCE.firstName, TARGET.lastName = SOURCE.lastName, TARGET.code = SOURCE.code \n" +
                        "WHEN NOT MATCHED BY TARGET \n" +
                        "THEN INSERT (code, isDeleted, firstName,lastName) VALUES (SOURCE.code, SOURCE.isDeleted, SOURCE.firstName,SOURCE.lastName)\n" +
                        "OUTPUT $action, \n" +
